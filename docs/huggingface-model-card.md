...
The **256-component `lateral` vector at alpha −0.1** increases world-Y velocity by **+0.40238 m/s**, paired 95% interval **[+0.30803, +0.49127]**, on **30 fresh paired confirmation episodes**, while retaining **96.83%** of baseline forward speed. This is sideways displacement in the world's ground plane, with heading involvement; it does not establish body-relative sidestepping or jumping.

The recorded outcome remains **`confirmation_failed`**: an additional strict rule rejects any episode ending before steering. Seed 520025 ends identically at step 34 in both arms, before steering begins at step 100. Failure counts are 4/30 in both arms, on partly different seeds. Mean squared action rises 17.84%, and original reward decreases. No independent replication or practical-target application was performed. [The findings](https://github.com/BurnyCoder/rl-locomotion-steering-vectors/blob/main/reports/ant-classic-005-findings.md) and [causal audit](https://github.com/BurnyCoder/rl-locomotion-steering-vectors/blob/main/reports/ant-classic-005-causal-audit.md) preserve the controls, costs, and limitations.
